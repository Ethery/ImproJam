...
public class AStar
{
	...
	public static matrixNode GetNextMatrixNode(char[][] matrix, int fromX, int fromY, int toX, int toY)
	{
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static void unitTest_AStar()
	{
		...
		matrixNode endNode = GetNextMatrixNode(matrix, fromX, fromY, toX, toY);
